                    ...
                    <div className="mx-auto mt-16 max-w-2xl  lg:max-w-4xl">
                        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-1 lg:gap-y-16">
                            <div data-aos="fade-up" className="relative pl-28">
                                ...
                                <dd className="mt-2 text-base leading-7 text-slate-800">
                                    <ul className="list-none">
                                        <li className="font-normal leading-6">I have extensive experience communicating and coordinating with others from my role within the Canadian military, which I can apply in any setting.
                                        </li>
                                    </ul>
                                </dd>
                            </div>
                            ...
                            <div data-aos="fade-up" className="relative pl-28">
                                ...
                                <dd className="mt-2 text-base leading-7 text-slate-800">
                                    <ul className="list-none">
                                        <li className="font-normal leading-6">Programmed scripts in Python to automate repetitive tasks to reduce time spent on manual procedures when organizing video databases to increase accessibility
                                        </li>
                                        <li className="font-normal leading-6">Implemented functions using REST API documentation for Panopto to implement python scripts
                                        </li>
                                    </ul>
                                </dd>
                            </div>
