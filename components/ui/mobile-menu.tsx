        ...
        <div className="md:hidden">
            ...
            >
                <ul className="bg-white px-4 py-2">
                    ...
                    {/*          className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-white bg-cyan-900 hover:bg-cyan-700 transition duration-150 ease-in-out"*/}
